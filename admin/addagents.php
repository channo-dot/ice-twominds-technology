...
<div class="item form-group">
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
    <input type="text" id="email" name="lname" required="required" class="form-control col-md-7 col-xs-12">
  </div>
</div>
...
<!-- <div class="item form-group">
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
    ...
    <textarea class="form-control col-md-7 col-xs-12" name = "address">
    </textarea>
  </div>
</div> -->
