        ...
        <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                          <?php 
                                ...
                                foreach($mn as $men){
                                  $db->where("uid",$men["id"]);
                                 $p = $db->getValue("user_info","pnumber");
							   ...
							   <td><?php echo $p; ?></td>
							   <td><a href="clients.php?id=<?php echo $men["id"]; ?>&mode=edit" class="fa fa-pencil btn btn-info btn-xs">Edit</a>
							   /
							   <a href="clients.php?id=<?php echo $men["id"]; ?>&mode=delete" class=" fa fa-trash-o btn btn-danger btn-xs">Delete</a></td>
							   </tr>
								<?php } ?>
