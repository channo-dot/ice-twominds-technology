                      ...
                      <tbody>
                          <?php 
						   ...
						   ?>
							   ...
							   <td><a href="agents.php?id=<?php echo $men["id"]; ?>&mode=edit" class="fa fa-pencil btn btn-info btn-xs ">Edit</a>
							  / <a href="agents.php?id=<?php echo $men["id"]; ?>&mode=delete" class=" fa fa-trash-o btn btn-danger btn-xs">Delete</a></td>
							   </tr>
								<?php } ?>
